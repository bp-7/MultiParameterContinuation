...
class PathAdaptiveMultiParameterContinuationHessian(AbstractContinuationPositioning):
    ...
    def __init__(self,
        ...
        self.differentialSolution = differentialSolution
        self.differentialParameter = differentialParameter
        self.F = F
        self.FCodomain = FCodomain
    ...
    def DetermineMetricMatrix(self):
        return self.differentialParameterMatrix.T @ self.differentialParameterMatrix
