...
from Visualization.VisualizationParabola import SubplotAnimationThreeDimensionalParameterSpace

plt.ion()

ani = SubplotAnimationThreeDimensionalParameterSpace(results,
